...
public class SOAPTask extends AbstractCustomServiceTask {
	...
	@PropertyItems({SOAPConstants.SOAP11_LABEL, SOAPConstants.SOAP11_VALUE, SOAPConstants.SOAP12_LABEL, SOAPConstants.SOAP12_VALUE})
	...
	@Help(displayHelpShort = SOAPConstants.HTTP_CONNECTION_HELP, displayHelpLong = SOAPConstants.HTTP_CONNECTION_HELP_LONG)
